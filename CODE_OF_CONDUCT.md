...
repository owner using the contact address on their GitHub profile. Reports are
reviewed promptly and fairly. The privacy and security of the reporter will be
respected.
...
2. **Warning:** A warning with consequences for continued behavior, including
   avoiding interaction with those involved for a specified period.
3. **Temporary ban:** A temporary ban from interaction or public communication
   with the community.
4. **Permanent ban:** Permanent removal for a pattern of violations, harassment,
   or aggression toward individuals or groups.
